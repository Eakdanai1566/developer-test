          ...
          <tr>
            ...
            <td class="body2">
                <div class="form-container">
                    <form action="/PHP/edit.php" method="POST" onsubmit="return validateForm()">
                    ...
                    <input type="text" id="regisplate" name="regisplate" value="<?php echo $regisplate?>">
                    ...
                    <input type="text-box" id="note" name="note" value="<?php echo $note?>">
